                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
                  ...
                  <div className="lg:col-span-6 flex items-center justify-center">
                    ...
                    >
                      ...
                      {/* Click overlay pill */}
                      <div className="absolute bottom-3 right-3 px-3 py-1 rounded-full bg-slate-900/80 dark:bg-zinc-950/80 backdrop-blur-md border border-slate-700/80 dark:border-zinc-700/80 text-[11px] font-mono text-white group-hover/img:border-purple-400 transition-colors flex items-center gap-1.5">
      ...
      {selectedProject && (
        ...
        >
          ...
          >
            ...
            {/* Modal Image Header */}
            <div className="relative w-full h-64 sm:h-80 md:h-96 rounded-2xl overflow-hidden bg-slate-100 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 shadow-inner">
              <SafeProjectImage
